...
import { getBranches, getDepartments, getDesignations, storeEmployee } from '@/lib/api';
...
const EmployeeEdit = () => {
    ...
    useEffect(() => {
        ...
        fetchDepartments();
    }, [form.branch_id]); // 👈 Depend on form.branch_id and setValue
    ...
    const onSubmit = async () => {
        ...
        try {
            ...
            await notify("Success!", "Employee Create.", "success");
                        ...
                        <form className="space-y-6">
                            ...
                            <div className="grid grid-cols-12 gap-4">
                                ...
                                <div className="col-span-6">
                                    <Label>Email</Label>
                                    <Input type="email" value={form?.user?.email} onChange={(e) => setForm({
                                        ...form,
                                        user: {
                                            ...form.user,
...
dark:bg-slate-700 dark:text-slate-400 dark:hover:bg-slate-600 dark:hover:text-slate-300">
                        ...
                        <button onClick={onSubmit} className="px-4 py-2 bg-primary hover:bg-primary-700 text-white text-xs font-bold uppercase tracking-wide rounded-lg shadow-lg shadow-primary-200 dark:shadow-none flex items-center gap-2">
                            Submit
                        </button>
                    </div>
                </div>
                ...
                <div className="w-full lg:w-80 xl:w-80 bg-slate-50/90 dark:bg-slate-900/60 p-6 flex flex-col items-center gap-6 order-1 lg:order-2 overflow-y-auto">
                    ...
                    <ImageUploader onImageSet={(e) => setForm({ ...form, profile_image_base64: e })} />
                            ...
                            <div className="flex gap-2">
                                <div className="relative flex-1">
                                    <Input
                                        ...
                                        value={form?.user?.password} onChange={(e) => setForm({
                                            ...form,
                                            user: {
                                                ...form.user,
