  ...
  return (
    <div className={`relative w-full ${className}`}>
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <div className="relative w-full">
            <Input
              ...
              className={`w-full rounded-lg border-border-light darks:border-border-dark bg-background-light darks:bg-gray-800/50 text-text-strong-light darks:text-text-strong-dark focus:ring-2 focus:ring-[var(--primary)] focus:border-[var(--primary)] pr-10 text-sm transition-all ${inputClassName}`}
              {...rest}
            />
            <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 darks:text-gray-400">
        ...
        <PopoverContent
          align="start"
          className="w-50 rounded-lg p-4 shadow-lg border border-border-light darks:border-border-dark bg-background-light darks:bg-gray-800/90"
        >
